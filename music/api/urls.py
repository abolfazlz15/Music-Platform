...
urlpatterns = [
    ...
    path(
        "musicbycategory/",
        views.MusicByCategoryListView.as_view(),
        name="music_by_category",
    ),
    path(
        "trendmusic/",
        views.MusicByTrendCategoryListView.as_view(),
        name="music_by_trend_category",
    ),
    path("sliderhomepage/", views.SliderHomePage.as_view(), name="slider_home_page"),
    path(
        "internationals/",
        views.InternationalMusicList.as_view(),
        name="international_music",
    ),
    path(
        "favoritemusic/<int:pk>",
        views.UserFavoriteMusicView.as_view(),
        name="user_favorite_music",
    ),
    path(
        "favoritemusic/add",
        views.UserAddFavoriteMusicView.as_view(),
        name="user_add_favorite_music",
    ),
    path("detail/<int:pk>/", views.MusicDetailView.as_view(), name="music_detail"),
    path("search/", views.MusicSearchView.as_view(), name="search_music"),
    # category URL
