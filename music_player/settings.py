...
MIDDLEWARE = [
    ...
    'music.middleware.SaveIPAddressMiddleware',
]
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=int(config('JWT_ACCESS_TOKEN_TIME'))),
    'REFRESH_TOKEN_LIFETIME': timedelta(days=int(config('JWT_REFRESH_TOKEN_TIME'))),
}
